const STATUS_MESSAGES = {
  ...
  AUTH: {
    ...
    REGISTER_FAILED: { code: 400, message: "Registration failed. Please try again." },
    ...
    TOKEN_EXPIRED: { code: 401, message: "Session expired. Please log in again." },
  },
  ...
  TEST: {
    ...
    TIME_EXCEEDED: { code: 400, message: "Time limit exceeded. Test not submitted." },
    INVALID_TEST_ID: { code: 400, message: "Invalid test ID." },
  },

  // Feedback
  FEEDBACK: {
    FEEDBACK_SUBMITTED: { code: 200, message: "Feedback submitted successfully." },
    FEEDBACK_FAILED: { code: 500, message: "Feedback submission failed. Try again." },
